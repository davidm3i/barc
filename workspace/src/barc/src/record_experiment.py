...
rosbag_dir = os.path.expanduser("~/simulations") + '/rosbag'
video_dir = os.path.expanduser("~/simulations") + '/video'
image_dir = os.path.expanduser("~/simulations") + '/images'
...
class RecordExperiment():
    def __init__(self):
        ...
        self.topics = ['/imu/data', '/encoder', '/ecu', '/ecu_pwm', '/image_transformed/compressed/', '/fix', '/pos_info', '/state_estimate', '/ecu0', '/ecu2']
